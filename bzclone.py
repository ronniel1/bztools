...
def clonebug(bzclient, bugid, version=None):
    ...
    external_bugs = [{'ext_bz_bug_url':
                      'https://bugzilla.redhat.com/show_bug.cgi?id={}'.format(source_bug.id)}]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Clone BZ bug and mark the new bug for 4.8.0")
    ...
    loginArgs.add_argument("-bup", "--bugzilla-user-password",
                           required=False,
